...
interestjob: _entity?.interestjob,
suitablejob: _entity?.suitablejob,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info jobclassified created successfully" });
...
<div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
                <label htmlFor="interestjob">Job Interest:</label>
                <InputText id="interestjob" className="w-full mb-3 p-inputtext-sm" value={_entity?.interestjob} onChange={(e) => setValByKey("interestjob", e.target.value)}  />
            </span>
            </div>
<div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
