...
const JobclassifiedDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    const dt = useRef(null);
    const urlParams = useParams();
    const [showUpload, setShowUpload] =useState(false)

const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.skills}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.interestjob}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.suitablejob}</p>
...
<Column field="skills" header="Skills" body={pTemplate0} style={{ minWidth: "8rem" }} />
<Column field="interestjob" header="Job Interest" body={pTemplate1} sortable style={{ minWidth: "8rem" }} />
<Column field="suitablejob" header="Suitable Job" body={pTemplate2} style={{ minWidth: "8rem" }} />
