...
<Column field="employeeName" header="Employee Name" body={dropdownTemplate0} style={{ minWidth: "8rem" }} />
<Column field="employeeInterest" header="EmployeeInterest" body={dropdownTemplate1} sortable style={{ minWidth: "8rem" }} />
<Column field="suitableJobs" header="SuitableJobs" body={pTemplate2} style={{ minWidth: "8rem" }} />
