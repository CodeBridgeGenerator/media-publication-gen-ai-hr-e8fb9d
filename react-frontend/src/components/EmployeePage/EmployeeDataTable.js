...
const pTemplate6 = (rowData, { rowIndex }) => <p >{rowData.employeeInterest}</p>
const pTemplate7 = (rowData, { rowIndex }) => <p >{rowData.suitableJob}</p>
...
<Column field="age" header="Age" body={p_numberTemplate1} sortable style={{ minWidth: "8rem" }} />
<Column field="department" header="Department" body={pTemplate2} sortable style={{ minWidth: "8rem" }} />
<Column field="yearOfService" header="No. of Year Service" body={p_numberTemplate3} sortable style={{ minWidth: "8rem" }} />
<Column field="jobTitle" header="JobTitle" body={pTemplate4} sortable style={{ minWidth: "8rem" }} />
<Column field="skills" header="Skills" body={pTemplate5} style={{ minWidth: "8rem" }} />
<Column field="employeeInterest" header="Employee Interest" body={pTemplate6} style={{ minWidth: "8rem" }} />
<Column field="suitableJob" header="Suitable Job" body={pTemplate7} style={{ minWidth: "8rem" }} />
        ...
        <Dialog header="Upload Employee Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService />
      </Dialog>
        </>
    );
