...
const HumanResourcesDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
...
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.employee}</p>
...
<Column field="employee" header="Employee" body={pTemplate2} style={{ minWidth: "8rem" }} />
        ...
        <Dialog header="Upload HumanResources Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService />
      </Dialog>
        </>
    );
...
export default HumanResourcesDataTable;