...
const EmployeeDetailsDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
...
<Column field="jobTitle" header="Job Title" body={pTemplate4} sortable style={{ minWidth: "8rem" }} />
